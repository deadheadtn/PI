...
public class MotDePasseOublieController implements Initializable{
    ...
    private void SendMail(ActionEvent event) throws UnsupportedEncodingException, MessagingException {
        ...
        user = userDAO.getByEmail(email.getText().toLowerCase().trim());
        if (user.getSexe().equals("Femelle")){ s = "Mme";}
        else {
        s = "Mr";
        }
        ...
        m.Send(user.getEmail_canonical(), "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n"
                    + "\n"
                 ...
                 //   + "					                  		<img src=\"http://img15.hostingpics.net/pics/857093logoAll.png\" width=\"155\" height=\"155\"  alt='Logo'  data-default=\"placeholder\" />\n"
                    ...
                    + "					                	<div class=\"contentEditable\" align='center' >\n"
                    + "					                  		<h2 >RUSSIA WORLD CUP SERVICE</h2>\n"
                    + "					                	</div>\n"
                    + "					              	</div>\n"
                    + "								</td>\n"
                    + "							</tr>\n"
                    ...
                    + "												<div class=\"contentEditableContainer contentTextEditable\">\n"
                    + "								                	<div class=\"contentEditable\" align='center' >\n"
                    + "								                  		<a class='link2'>Visiter notre site</a>\n"
                    + "								                	</div>\n"
                    + "								              	</div>\n"
                    + "											</td>\n"
                    + "										</tr>\n"
                    ...
                    + "									<div class=\"contentEditableContainer contentTextEditable\">\n"
                    + "					                	<div class=\"contentEditable\" align='left' >\n"
                    + "					                  		<span style=\"font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;\">Sent to " + user.getEmail_canonical() + " by RUSSIA WORLD CUP 2018</span>\n"
                    + "											<br/>\n"
    ...
    buttonError.setVisible(false);
         ...
         buttonRetLogin.setOnMouseClicked((MouseEvent event) -> {
         //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
         try {
             
             Stage stage = new Stage();
             Stage stageprev = (Stage) buttonRetLogin.getScene().getWindow();
