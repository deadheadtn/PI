...
--
-- Client :  localhost
-- Généré le :  Ven 09 Février 2018 à 10:19
...
--
ALTER TABLE `follow_up`
  MODIFY `ID_FOLLOWUP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `FK_ACHETER` FOREIGN KEY (`ID_TRANSPORT`) REFERENCES `transport` (`ID_TRANSPORT`),
